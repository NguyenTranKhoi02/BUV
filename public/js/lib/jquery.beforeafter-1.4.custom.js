    ...
    $.fn.extend({
        beforeAfter: function (options) {
            return this.each(function () {
                ...
                var position_percent = options.introPosition;
                ...
                obj.find('.twentytwenty-container').twentytwenty({ 
					default_offset_pct   : position_percent, 	// How much of the before image is visible when the page loads
